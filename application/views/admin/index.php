            ...
            <div class="card border-left-danger shadow h-100 py-2 bg-primary">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white text-uppercase mb-1">Supir</div>
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $this->ModelSupir->getUserWhere(['role_user' => 1])->num_rows(); ?></div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"> <?php $where = ['status_booking !=0'];
                                                                                $totaldibooking = $this->ModelBuku->total('status_booking', $where);
